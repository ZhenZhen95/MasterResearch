...
ann_filepath = 'C:/VOCdevkit/VOC2012/Annotations/'
img_filepath = 'C:/VOCdevkit/VOC2012/JPEGImages/'
img_savepath = 'C:TrafficDatasets/JPEGImages/'
ann_savepath = 'C:TrafficDatasets/Annotations/'
...
for file in os.listdir(ann_filepath):
    ...
    ind_start.append(a)  # <object>的行数
    lines_id_start[a] = "delete"

    while "\t</object>\n" in lines_id_end:
        b = lines_id_end.index("\t</object>\n")
    ind_end.append(b)  # </object>的行数
