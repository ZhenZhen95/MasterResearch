...
while cv.waitKey(1) < 0:
    ...
    if object_type == 'bicycle':
        classesFile = "yolo-coco/bicycle/bicycle.names"
        classes = None
        with open(classesFile, 'rt') as f:
            classes = f.read().rstrip('\n').split('\n')

        # Give the configuration and weight files for the model and load the network using them.
        modelWeights = "yolo-coco/bicycle/bicycle.weights"
        modelConfiguration = "yolo-coco/yolov4-tiny.cfg"
        ...
        cv.imshow(winName, frame)
    if object_type == 'motorbike':
        classesFile = "yolo-coco/motorbike/motorbike.names"
        classes = None
        with open(classesFile, 'rt') as f:
            classes = f.read().rstrip('\n').split('\n')

        # Give the configuration and weight files for the model and load the network using them.
        modelWeights = "yolo-coco/motorbike/motorbike.weights"
        modelConfiguration = "yolo-coco/yolov4-tiny.cfg"
    ...
    if object_type == 'train':
        classesFile = "yolo-coco/train/train.names"
        classes = None
        with open(classesFile, 'rt') as f:
            classes = f.read().rstrip('\n').split('\n')

        # Give the configuration and weight files for the model and load the network using them.
        modelWeights = "yolo-coco/train/train.weights"
        modelConfiguration = "yolo-coco/yolov4-tiny.cfg"
    ...
    if object_type == 'bird':
        classesFile = "yolo-coco/bird/bird.names"
        classes = None
        with open(classesFile, 'rt') as f:
            classes = f.read().rstrip('\n').split('\n')

        # Give the configuration and weight files for the model and load the network using them.
        modelWeights = "yolo-coco/bird/bird.weights"
        modelConfiguration = "yolo-coco/yolov4-tiny.cfg"
        ...
        cv.imshow(winName, frame)
    if object_type == 'cat':
        classesFile = "yolo-coco/cat/cat.names"
        classes = None
        with open(classesFile, 'rt') as f:
            classes = f.read().rstrip('\n').split('\n')

        # Give the configuration and weight files for the model and load the network using them.
        modelWeights = "yolo-coco/cat/cat.weights"
        modelConfiguration = "yolo-coco/yolov4-tiny.cfg"
        ...
        cv.imshow(winName, frame)
    if object_type == 'dog':
        classesFile = "yolo-coco/dog/dog.names"
        classes = None
        with open(classesFile, 'rt') as f:
            classes = f.read().rstrip('\n').split('\n')

        # Give the configuration and weight files for the model and load the network using them.
        modelWeights = "yolo-coco/dog/dog.weights"
        modelConfiguration = "yolo-coco/yolov4-tiny.cfg"
        ...
        cv.imshow(winName, frame)
    if object_type == 'cow':
        classesFile = "yolo-coco/cow/cow.names"
        classes = None
        with open(classesFile, 'rt') as f:
            classes = f.read().rstrip('\n').split('\n')

        # Give the configuration and weight files for the model and load the network using them.
        modelWeights = "yolo-coco/cow/cow.weights"
        modelConfiguration = "yolo-coco/yolov4-tiny.cfg"
    ...
    if object_type == 'sheep':
        classesFile = "yolo-coco/sheep/sheep.names"
        classes = None
        with open(classesFile, 'rt') as f:
            classes = f.read().rstrip('\n').split('\n')

        # Give the configuration and weight files for the model and load the network using them.
        modelWeights = "yolo-coco/sheep/sheep.weights"
        modelConfiguration = "yolo-coco/yolov4-tiny.cfg"
    ...
    if object_type == 'table':
        classesFile = "yolo-coco/table/table.names"
        classes = None
        with open(classesFile, 'rt') as f:
            classes = f.read().rstrip('\n').split('\n')

        # Give the configuration and weight files for the model and load the network using them.
        modelWeights = "yolo-coco/table/table.weights"
        modelConfiguration = "yolo-coco/yolov4-tiny.cfg"
